        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    SiteTitle = table.Column<string>(type: "character varying(256)", maxLength: 256, nullable: false),
                    ...
                    UiFont = table.Column<string>(type: "character varying(128)", maxLength: 128, nullable: false),
                    DocumentFont = table.Column<string>(type: "character varying(128)", maxLength: 128, nullable: false),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_SiteSettings_Assets_FaviconAssetId",
                        column: x => x.FaviconAssetId,
                        principalTable: "Assets",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.SetNull);
                    table.ForeignKey(
                        name: "FK_SiteSettings_Assets_LogoAssetId",
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    SearchContent = table.Column<string>(type: "text", nullable: false, defaultValue: ""),
                    SearchVector = table.Column<NpgsqlTsVector>(type: "tsvector", nullable: false)
                        .Annotation("Npgsql:TsVectorConfig", "english")
                        .Annotation("Npgsql:TsVectorProperties", new[] { "Title", "SearchContent" })
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_DocumentVersions_Users_AuthorUserId",
            ...
            migrationBuilder.InsertData(
                table: "SiteSettings",
                columns: new[] { "Id", "CompanyName", "DocumentFont", "FaviconAssetId", "IsInitialized", "LogoAssetId", "MetaDescription", "SiteTitle", "UiFont" },
                values: new object[] { 1, "", "Inter", null, false, null, null, "", "Inter" });
            ...
            migrationBuilder.CreateIndex(
                name: "IX_DocumentVersions_AuthorUserId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Permissions_GroupId_ResourceType_ResourceId",
                table: "Permissions",
                columns: new[] { "GroupId", "ResourceType", "ResourceId" },
                unique: true);

            migrationBuilder.CreateIndex(
                name: "IX_Permissions_ResourceType_ResourceId",
                table: "Permissions",
                columns: new[] { "ResourceType", "ResourceId" });
            ...
            migrationBuilder.CreateIndex(
                name: "IX_SiteSettings_FaviconAssetId",
                table: "SiteSettings",
                column: "FaviconAssetId");

            migrationBuilder.CreateIndex(
                name: "IX_SiteSettings_LogoAssetId",
                table: "SiteSettings",
                column: "LogoAssetId");
