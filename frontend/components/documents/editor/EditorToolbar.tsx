...
export function EditorToolbar({ editor, mode, onToggleMode, onImageSelect, isUploadingImage }: EditorToolbarProps) {
  ...
  return (
    <div className="flex flex-wrap items-center gap-1 rounded-t-xl border border-b-0 border-zinc-200 bg-zinc-50 p-2">
      ...
      <div className="ml-auto">
        <button
          ...
          className="flex items-center gap-1.5 rounded-md border border-zinc-200 bg-white px-2.5 py-1.5 text-xs font-medium text-zinc-600 transition-colors hover:border-primary-300 hover:text-primary-600"
        >
